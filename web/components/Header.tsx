    ...
    <header className="sticky top-0 z-[2000] bg-white/80 dark:bg-slate-900/90 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-lg transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          <div className="rounded-lg border border-red-200 dark:border-red-500/30 transition-colors">
            <img
              src="https://storage-portfolio.monzim.com/projects/bd-quake/bd-quake-logo-black.webp"
              alt="BD Quake Monitor Logo"
